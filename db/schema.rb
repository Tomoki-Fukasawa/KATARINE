...
ActiveRecord::Schema[7.1].define(version: 2026_03_13_120634) do
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.index ["item_request_id"], name: "index_addresses_on_item_request_id"
  end
  ...
  create_table "item_requests", force: :cascade do |t|
    ...
    t.index ["receiver_id"], name: "index_item_requests_on_receiver_id"
  ...
  add_foreign_key "addresses", "item_requests"
  ...
  add_foreign_key "item_requests", "users", column: "receiver_id"
